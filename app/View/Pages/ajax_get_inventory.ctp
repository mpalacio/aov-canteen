	...
	<?php
		foreach ($products as $product) {
			...
			echo "<td>
				...
				<a data-delete='{$product['Product']['id']}' title='Delete Product' data-disabled='".($product['CurrentStock']['sold_count'] > 0 ? "true" : "false")."'><i class='glyphicon glyphicon-trash'></i></a>
